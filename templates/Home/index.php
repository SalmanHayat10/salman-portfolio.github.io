...
<section id="about" class="about">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img src="<?= $this->request->getAttribute('webroot') . $abouts['0']['media']['directory'] . $abouts['0']['media']['value'] ?>"
